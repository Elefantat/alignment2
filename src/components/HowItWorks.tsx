...
const steps = [
  { icon: Users, title: 'Connect', description: 'Join a community who gets it', color: 'sage' },
  { icon: Brain, title: 'Reflect', description: 'Have a yarn with the AI', color: 'wheat' },
  { icon: Sparkles, title: 'Grow', description: 'Gain insights about yourself', color: 'terra' },
  { icon: Target, title: 'Integrate', description: 'Set practical goals', color: 'sky' },
  { icon: Headphones, title: 'Support', description: '24/7 when you need it', color: 'sage' },
]
              ...
              return (
                <div key={step.title} className="group relative">
                  <div className="card-warm p-6 text-center h-full">
                    ...
                    <h3 className="text-xl font-display font-semibold text-soil-800 mb-2">{step.title}</h3>
