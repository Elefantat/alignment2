  ...
  return (
    <section className="relative py-20 md:py-28 overflow-hidden">
      ...
      <div 
        ...
        style={{
          background: 'linear-gradient(180deg, #FBF9F3 0%, #F5F0E6 50%, #F9EDCC 100%)',
        }}
      />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <span className="inline-block px-4 py-2 rounded-full bg-terra-100 border border-terra-200 text-terra-500 text-sm font-medium mb-6">
          ...
          <p className="text-xl text-soil-600 max-w-2xl mx-auto">
            Alignment speaks your language and understands the unique challenges of your lifestyle
          </p>
        </div>
        
        {/* Cards container - same width for featured and grid */}
        <div className="flex justify-center">
          <div className="w-full max-w-5xl">
            {/* Featured Card - Rural & Agricultural */}
            <div className="mb-8">
              <div className="card-warm overflow-hidden border-2 border-sage-300">
                <div className="grid md:grid-cols-2">
                  <div className="relative h-64 md:h-auto min-h-[280px]">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent to-white/20 md:bg-gradient-to-t md:from-transparent md:to-transparent" />
                  </div>
                  <div className="p-8 md:p-10 flex flex-col justify-center">
                    ...
                    <h3 className="text-2xl md:text-3xl font-display font-semibold text-soil-800 mb-4">
                      {lenses[0].title}
                    </h3>
                    <p className="text-lg text-soil-600 leading-relaxed mb-6">
                      {lenses[0].description}
                    </p>
                    <p className="text-soil-500 leading-relaxed">
                      Whether you&apos;re dealing with drought, market pressures, succession planning, or just the isolation that comes with remote life – Alignment gets it. Built with input from real farmers across Australia.
                    </p>
                  </div>
                </div>
              </div>
            ...
            {/* Other cards grid - 6 cards, 3 columns */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {lenses.slice(1).map((lens) => (
                ...
                >
                  ...
                  {/* Content */}
                  <div className="p-5">
                    <h3 className="text-lg font-display font-semibold text-soil-800 mb-2">
                      {lens.title}
                    </h3>
