...
export default function AlignmentSections() {
  return (
    <section className="relative py-20 md:py-28 overflow-hidden">
      {/* Background with subtle field image */}
      <div 
      ...
      <div 
        ...
        style={{
          background: 'linear-gradient(180deg, rgba(251, 249, 243, 0.95) 0%, rgba(245, 240, 230, 0.9) 50%, rgba(251, 249, 243, 0.95) 100%)',
        }}
      />
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16 md:space-y-20">
        ...
        <div className="card-warm p-8 md:p-12 border border-wheat-200">
          <div className="space-y-8">
            <div>
              <span className="inline-block px-4 py-2 rounded-full bg-wheat-100 border border-wheat-200 text-wheat-600 text-sm font-medium mb-6">
                The Journey
              </span>
              <h2 className="text-3xl md:text-4xl font-display font-semibold text-soil-800 mb-6">
                How <span className="gradient-text-warm">Alignment</span> Works
              </h2>
            </div>
            
            <div className="space-y-4 text-soil-600 text-lg leading-relaxed">
              <p>
                Alignment listens to your reality and adapts to your world. It helps you understand what&apos;s sitting beneath your emotions, recognise patterns, and make sense of your inner world in a grounded, practical way.
              </p>
              <p>
                When you&apos;re ready, Alignment connects you to people and services that fit your situation. Its Resource Library provides tailored recommendations that surface the right tools, stories, and guidance for what you&apos;re facing.
              </p>
            </div>
                  ...
                  return (
                    <div key={step.title} className="flex items-center">
                      ...
                      <div className="flex flex-col items-center group cursor-pointer">
                        ...
                        <span className="mt-3 text-xs md:text-sm font-medium text-soil-600 text-center whitespace-pre-line leading-tight">
                          {step.title}
                        </span>
                      </div>
          ...
          <div className="space-y-8">
            <div className="flex items-start justify-between gap-6">
              <div>
                ...
                <h2 className="text-3xl md:text-4xl font-display font-semibold text-soil-800">
                  Social Impact & <span className="gradient-text-earth">Giving Back</span>
                </h2>
              </div>
              ...
              <div className="hidden md:block flex-shrink-0">
                <div className="w-20 h-20 rounded-2xl bg-wheat-100 border border-wheat-200 flex items-center justify-center">
                  <svg viewBox="0 0 60 60" className="w-12 h-12">
                    ...
                    <ellipse cx="22" cy="32" rx="6" ry="10" fill="#558B2F" opacity="0.5" transform="rotate(-10 22 32)" />
                    <ellipse cx="38" cy="32" rx="6" ry="10" fill="#558B2F" opacity="0.5" transform="rotate(10 38 32)" />
                  </svg>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-5 text-soil-600 text-lg leading-relaxed">
              ...
              <div className="my-8 p-6 rounded-2xl bg-gradient-to-r from-sage-100 to-wheat-100 border border-sage-200">
                <div className="flex items-center gap-6">
                  <div className="text-5xl md:text-6xl font-display font-semibold text-sage-600">
                    10%
                  </div>
                  <p className="text-soil-700">
                    of annual net revenue goes to our Access & Outreach Fund, offering <strong>free access</strong> to rural and remote communities
                  </p>
                </div>
              </div>
